...
The following is a set of guidelines for contributing to the Apollo ZK subnet. These are **HIGHLY RECOMMENDED** guidelines, but not hard-and-fast rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
The discord channel can be found [here](https://discord.com/channels/799672011265015819/1222672871092912262).

### Code Contribution General Guidelines

> Please follow the Apollo ZK Subnet [style guide](./STYLE.md) regardless of your contribution type. 
...
1. Include relevant tests for any fixed bugs or new features.
2. Ensure your commit messages are clear and concise. Include the issue number if applicable.
3. If you have multiple commits, rebase them into a single commit using `git rebase -i`.
4. Explain what your changes do and why you think they should be merged in the PR description consistent with the [style guide](./STYLE.md).
...
> **Always** follow the [style guide](./STYLE.md) before submitting pull requests.
...
* If the problem started happening recently, **can you reproduce the problem in an older version of Apollo ZK?** 
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of Apollo ZK Subnet are you using?**
...
* **Are you running Apollo ZK Subnet in a virtual machine?** If so, which VM software are you using and which operating systems and versions are used for the host and the guest?
* **Are you running Apollo ZK Subnet in a dockerized container?** If so, have you made sure that your docker container contains your latest changes and is up to date with Master branch?

Thank you for considering contributing to Apollo ZK! Any help is greatly appreciated along this journey to incentivize open and permissionless high-powered proving networks!
